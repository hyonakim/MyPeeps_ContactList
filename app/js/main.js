...
var AppKey = 'FQL0LFMHeI37PmdE46pyVwbmL2nGuw5dbNtL29tn';
var APIKey = 'vLiUrimLWsNeI9QV4ZEzhiyW7wj8h9vEdiOJfHDK';
...
},{"./ajax_setup":1,"./router":5,"jquery":9,"moment":10,"underscore":11}],4:[function(require,module,exports){
'use strict';
...
},{"./contact_model":2,"backbone":8}],5:[function(require,module,exports){
'use strict';
...
var _viewsPersonTemplate = require('./views/personTemplate');

var _viewsPersonTemplate2 = _interopRequireDefault(_viewsPersonTemplate);
...
var Router = _backbone2['default'].Router.extend({
	...
	initialize: function initialize(appElement) {
		...
		this.people = new _people_collection2['default']();
	...
	showSpinner: function showSpinner() {
		this.$el.html('<i class="fa fa-circle-o-notch fa-spin"></i>');
	},

	showBackBtn: function showBackBtn() {
		this.$el.html(React.createElement('i', { 'class': 'fa fa-arrow-left' }));
	},
	...
	showPeople: function showPeople() {
		...
		this.people.fetch().then(function () {
			router.$el.html((0, _viewsList2['default'])(router.people.toJSON()));
		});
	},

	showSpecificPerson: function showSpecificPerson(personId) {
		var _this = this;

		console.log('show each person');
		var person = this.people.get(personId);

		if (person) {
			this.$el.html((0, _viewsPersonTemplate2['default'])(person.toJSON()));
		} else {
			(function () {
				var router = _this;
				person = _this.people.add({ objectId: personId });
				_this.showSpinner();
				person.fetch().then(function () {
					router.$el.html((0, _viewsPersonTemplate2['default'])(person.toJSON()));
				});
			})();
		}
	},
...
},{"./people_collection":4,"./views/list":6,"./views/personTemplate":7,"backbone":8,"jquery":9}],6:[function(require,module,exports){
'use strict';
...
exports['default'] = peopleTemplate;
module.exports = exports['default'];
